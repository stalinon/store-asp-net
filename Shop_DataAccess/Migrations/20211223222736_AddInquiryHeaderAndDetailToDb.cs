        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IquiryHeaderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InquiryDetail_InquiryHeader_IquiryHeaderId",
                        column: x => x.IquiryHeaderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InquiryDetail_IquiryHeaderId",
                table: "InquiryDetail",
                column: "IquiryHeaderId");
